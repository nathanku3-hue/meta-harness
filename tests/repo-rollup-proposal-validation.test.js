...
test("valid selected proposal draft validates pass", () => {
  ...
  assert.deepEqual(Object.keys(rollup), ["schema_version", "generated_from", "ok", "summary", "response_handoff", "next_action_brief", "proposal_draft", "proposal_validation", "repos", "not_changed"]);
