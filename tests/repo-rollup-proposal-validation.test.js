...
test("valid selected proposal draft validates pass", () => {
  ...
  assert.deepEqual(Object.keys(rollup), ["schema_version", "generated_from", "ok", "summary", "response_handoff", "next_action_brief", "proposal_draft", "proposal_validation", "proposal_review_gate", "proposal_review_packet", "proposal_review_options", "proposal_review_receipt_template", "repos", "not_changed"]);
