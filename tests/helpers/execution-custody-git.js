...
/** Shared Git helpers for execution-custody fixtures. */
...
function resolveGit() {
  ...
  throw new Error("execution-custody-git: unable to resolve git");
}

function gitEnv(author = "meta-harness-custody-fixture") {
  return {
    ...process.env,
