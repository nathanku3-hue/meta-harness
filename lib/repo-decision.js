...
const REPO_DECISION_SCHEMA = "repo-decision/v2";
const REPO_DECISION_DOMAIN = "meta-harness-repo-decision-bytes/v2";
...
function compileRepoDecision(repositoryPath, worldState) {
  ...
  const session = sealWorkSession({
    ...
    origin: { type: "REPO_DECISION", decisionDigest: decision.digest },
