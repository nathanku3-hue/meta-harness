...
function validateGithubTransport(value, publicationIntent) {
  ...
  if (value.releaseTag !== publicationIntent.gitTag
    || value.githubSha !== publicationIntent.gitTagTargetRevision
    || value.workflowSha !== publicationIntent.gitTagTargetRevision) {
    throw contractError(
      "PUBLICATION_TRANSPORT_RELEASE",
      "publication transport tag, checkout SHA, or workflow SHA differs from PublicationIntent",
    );
  }
