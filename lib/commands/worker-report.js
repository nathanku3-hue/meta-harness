...
function renderReport(reportInput) {
  return `User journey executed: ${reportInput.task}
Observable result produced: ${reportInput.result}
User accomplished or learned: ${reportInput.humanSummary || reportInput.result}
Product blocker: ${reportInput.blocker}
Next executable product action: ${reportInput.proposedNextAction}
Outcome: ${reportInput.outcome}
