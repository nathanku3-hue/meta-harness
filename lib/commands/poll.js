...
module.exports = async function runPoll(args, context) {
  ...
  if (options.rollup) {
    ...
    const manualWorkPacketArtifactValidation = manualWorkPacketVerify
      ? readManualWorkPacketArtifactForValidation(context, manualWorkPacketVerify, packetBoundaryRepos)
      : undefined;
