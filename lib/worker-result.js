...
const WORKER_RESULT_SCHEMA = Object.freeze({
  ...
  properties: {
    schemaVersion: { type: "string", const: "worker-result/v2" },
    status: { type: "string", enum: ["DONE", "PARTIAL", "STOP"] },
        ...
        anyOf: [
          {
            ...
            properties: {
              type: { type: "string", const: "WRITE" }, path: { type: "string" }, content: { type: "string" },
            },
          },
          {
            type: "object",
            additionalProperties: false,
            required: ["type", "path"],
            properties: { type: { type: "string", const: "DELETE" }, path: { type: "string" } },
          },
          {
            type: "object",
            additionalProperties: false,
            ...
            properties: {
              type: { type: "string", const: "MOVE" }, from: { type: "string" }, to: { type: "string" },
            },
          },
        ],
      },
          ...
          properties: {
            ...
            alternativesConsidered: {
              ...
              items: {
                ...
                properties: {
                  means: { type: "string", minLength: 1 },
                  disposition: { type: "string", enum: ["FAILED", "RULED_OUT", "AVAILABLE"] },
                  evidence: { type: "array", minItems: 1, items: { type: "string", minLength: 1 } },
                },
              },
            },
