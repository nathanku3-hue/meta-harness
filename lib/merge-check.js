...
function runMergeCheck(options = {}) {
  ...
  if (prMode) {
    ...
    baseName = prData.baseRefName;
    headName = prData.headRefName;
  }
  ...
  return {
    ...
    scope: scopeName,
    source: prMode
      ? { mode: "pr", pr: Number(options.pr), base: baseName, head: headName, url: prData.url }
      : { mode: "refs", base: baseName, head: headName },
