...
const commandSpecs = [
  ...
  },
  {
    ...
    usage: "meta-harness ready --target <repo> [--package-root <relative-path>] [--json] [--quick] [--read-only] [--no-exec] [--mode <local|strict|release>] [--strict-github-settings]",
    handler: "./commands/ready",
  },
  {
    name: "release",
    summary: "Freeze, transport, publish, and reconcile one exact terminal release without rebuilding.",
    usage: [
      "meta-harness release candidate <create|verify-preterminal|verify-publication> [evidence options]",
      "meta-harness release intent <prepare|commit|verify> [evidence, signed intent, or portable asset options]",
      "meta-harness release publish --from-env --json",
      "meta-harness release reconcile [terminal evidence options] --publication-intent <path> --publication-observation <path> --closure-output <path> --controller-instance-id <id> [--json]",
    ],
