...
const commandSpecs = [
  {
    ...
    usage: "meta-harness init [goal] [--owner <name>]",
  ...
  },
  {
    ...
    usage: "meta-harness event --stream <stream> --phase <phase> --action <text> --result <text>",
  ...
  },
  {
    ...
    summary: "Check bounded downstream domain governance pilot evidence.",
  ...
  },
  {
    ...
    usage: [
      ...
      "meta-harness skill preflight <skill-name> --target <repo> [--json]",
