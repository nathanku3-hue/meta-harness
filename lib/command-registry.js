...
const commandSpecs = [
  ...
  },
  {
    ...
    usage: [
      ...
      "meta-harness poll --rollup [--json] [--autonomy-approval-receipt <json>] [--autonomy-approval-receipt-file <path>] [--write-manual-work-packet <path>] [--verify-manual-work-packet <path>] [--write-operator-execution-plan <path>] [--verify-operator-execution-plan <path>] [--entry-authority-run-spec <json>] [--entry-authority-run-spec-file <path>] [--force]",
      "  (with --verify-operator-execution-plan always emits execution_readiness + live entry_authority + worker_entry_gate; worker entry fails closed without trusted expected identity)",
    ],
