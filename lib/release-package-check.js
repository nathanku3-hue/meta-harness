...
const RETIRED_PACKAGE_PATHS = Object.freeze([
  "internal/owner-tool/cli.js",
  "internal/owner-tool/owner-tool.js",
...
const REQUIRED_EXECUTION_PACKAGE_PATHS = Object.freeze([
  "lib/commands/authority.js",
  "lib/commands/execute.js",
  "lib/commands/release.js",
  "lib/contracts/index.js",
  "lib/contracts/mechanics-assessment.js",
  "lib/contracts/run-spec.js",
  ...
  "lib/semantic-kernel/black-box-proof.js",
  "lib/semantic-kernel/controller-binding.js",
  "lib/semantic-kernel/g-scope.js",
  "lib/semantic-kernel/integrated-candidate.js",
  "lib/semantic-kernel/mechanics-assessment.js",
  "lib/semantic-kernel/operation-bundle.js",
  "lib/semantic-kernel/owner-pin.js",
  "lib/semantic-kernel/publication-runtime.js",
  "lib/semantic-kernel/publication.js",
  "lib/semantic-kernel/release-candidate.js",
  "lib/semantic-kernel/release-verification.js",
  "lib/semantic-kernel/repository-state.js",
  "lib/semantic-kernel/reviewer-assessment.js",
  ...
  "lib/semantic-kernel/terminal-slice-assessment.js",
]);
...
function publishPackageChecks(targetRoot, packageInfo, lifecycleCheck, ids) {
  ...
  const executionBoundaryRequired = String(packageInfo.pkg.name).split("/").pop() === "meta-harness";
