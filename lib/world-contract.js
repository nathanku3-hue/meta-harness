...
function validateCause(cause, schemaVersion = WORLD_TRANSITION_SCHEMA) {
  ...
  if (schemaVersion !== LEGACY_WORLD_TRANSITION_SCHEMA && cause.type === "DELEGATION_LEARNING") {
    exactKeys(cause, ["type", "delegationLearningDigest", "interpretationDigest"], "worldTransition.cause");
    requireDigest(cause.delegationLearningDigest, "worldTransition.cause.delegationLearningDigest");
    requireDigest(cause.interpretationDigest, "worldTransition.cause.interpretationDigest");
    return;
  }
