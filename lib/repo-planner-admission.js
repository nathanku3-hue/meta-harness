...
const PLANNER_CANDIDATE_BATCH_SCHEMA_VERSION = "planner-candidate-batch/v1";
...
const PLANNER_CANDIDATE_BATCH_SCHEMA = Object.freeze({
  ...
  properties: {
    schemaVersion: { const: PLANNER_CANDIDATE_BATCH_SCHEMA_VERSION },
...
function admitPreparedPlannerCandidate(repositoryPath, current, prepared, { now = new Date() } = {}) {
