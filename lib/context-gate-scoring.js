...
function evaluateProductOutcome() {
  return unknownResult("product_outcome", [], {
    structuralBlocker: "Product outcome authority requires a terminal slice assessment",
    question: "Which owner-signed SliceAuthorization and terminal evidence establish the product result?",
    summary: "Status prose, event prose, decision IDs, and words such as complete or accepted carry no product authority.",
  });
}
