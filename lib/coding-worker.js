...
function buildCodingPrompt(session, { attempt, priorFailure, workspaceMode, executionPermit }) {
  ...
  return [
    ...
    "Your sandbox is intentionally read-only. That is not a blocker: implement by returning complete file contents in changes for controller materialization.",
    ...
    "- Implement the accepted task by returning every required file as a complete { path, content } entry inside changes; Meta-Harness owns materialization.",
