...
const RESERVED_CHECK_PREFIXES = [
  ...
  "MH_NPM_SCRIPTS_", "MH_DOMAIN_", "MH_SKILL_", "MH_SUBAGENT_", "MH_ROLLUP_", "MH_AUTONOMY_", "MH_CONTEXT_GATE_", "MH_TRANSITION_GRAPH_", "MH_TRUTH_",
];
...
const DEFAULT_POLICY = Object.freeze({
  ...
  surface_ceiling: { max_cli_commands: 25, max_check_ids_global_warn: 21, max_template_count: 30 },
