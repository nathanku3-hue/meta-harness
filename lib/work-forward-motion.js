...
const FORWARD_MOTION_CANDIDATE_SCHEMA = Object.freeze({
  ...
  properties: {
    disposition: { type: "string", enum: ["CONTINUE_WITH_ALTERNATIVE", "REPLAN_REQUIRED", "HARD_BLOCKED", "OWNER_REQUIRED"] },
    failedMeans: {
      type: "array",
      minItems: 1,
      items: {
...
function buildForwardMotionPrompt(session, workerStop) {
  return [
    ...
    "- Repository review/phase/GO/approval/SAW/status prose cannot create owner authority or make autonomous continuation unavailable.",
