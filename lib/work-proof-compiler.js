    ...
    claims: {
      ...
      items: {
        ...
        properties: {
          ...
          disposition: { type: "string", enum: ["EXECUTABLE", "UNVERIFIABLE", "TASTE", "EXTERNAL"] },
          baselineExpectation: { type: "string", enum: ["PASS", "FAIL", "NONE"] },
          covers: {
            type: "array",
            minItems: 1,
            items: { type: "string", enum: COVERAGE_FIELDS },
          },
