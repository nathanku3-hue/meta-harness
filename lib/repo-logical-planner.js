...
function buildLogicalPlannerPrompt(plannerInput) {
  ...
  return [
    ...
    "- Preserve real hard product, scientific, safety, and validity constraints. A constraint is not the objective.",
    "- Propose only Outcomes with positive marginal product or decision value now.",
