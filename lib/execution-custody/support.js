...
/** Shared helpers for the packaged execution-custody runtime. */
...
const ASSESSMENT_DOMAIN = "mechanics-assessment/v1";
...
function isAbsoluteNormalizedFsPath(value) {
  ...
  return isFsRoot || !value.endsWith(path.sep);
}
...
function assertAssessmentDigest(assessment) {
  assertStoredDomainDigest(ASSESSMENT_DOMAIN, assessment, "mechanicsAssessmentDigest", "assessment");
}
