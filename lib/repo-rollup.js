...
const proposalReviewReceiptTemplate = require("./repo-rollup-proposal-review-receipt-template"), proposalReviewReceiptValidation = require("./repo-rollup-proposal-review-" + "receipt-validation"), proposalReviewCopyBlock = require("./repo-rollup-proposal-review-copy-block");
...
function renderRepoRollupMarkdown(rollup) {
  ...
  lines.push(...proposalReviewReceiptTemplate.renderProposalReviewReceiptTemplateMarkdown(rollup.proposal_review_receipt_template)); lines.push(...proposalReviewReceiptValidation.renderProposalReviewReceiptValidationMarkdown(rollup["proposal_review_" + "receipt_validation"])); lines.push(...proposalReviewCopyBlock.renderProposalReviewCopyBlockMarkdown(rollup.proposal_review_copy_block));
  return `${lines.join("\n")}\n`;
}
