...
function buildRepoRollup(root, options = {}) {
  ...
  return {
    ...
    manual_work_packet_artifact_validation: options.manualWorkPacketArtifactValidation || packetArtifactValidation.defaultManualWorkPacketArtifactValidation(),
    repos,
...
function renderRepoRollupMarkdown(rollup) {
  ...
  lines.push(...proposalValidation.renderProposalValidationMarkdown(rollup.proposal_validation));
  lines.push(...proposalReviewGate.renderProposalReviewGateMarkdown(rollup.proposal_review_gate));
  lines.push(...proposalReviewPacket.renderProposalReviewPacketMarkdown(rollup.proposal_review_packet));
  lines.push(...proposalReviewOptions.renderProposalReviewOptionsMarkdown(rollup.proposal_review_options));
  lines.push(...proposalReviewReceiptTemplate.renderProposalReviewReceiptTemplateMarkdown(rollup.proposal_review_receipt_template));
  lines.push(...proposalReviewReceiptValidation.renderProposalReviewReceiptValidationMarkdown(rollup["proposal_review_" + "receipt_validation"]));
  lines.push(...proposalReviewCopyBlock.renderProposalReviewCopyBlockMarkdown(rollup.proposal_review_copy_block));
  lines.push(...proposalReviewCopyBlockValidation.renderProposalReviewCopyBlockValidationMarkdown(rollup.proposal_review_copy_block_validation));
  lines.push(...proposalReviewExportIntent.renderProposalReviewExportIntentMarkdown(rollup.proposal_review_export_intent));
  lines.push(...proposalReviewExportSafetyGate.renderProposalReviewExportSafetyGateMarkdown(rollup.proposal_review_export_safety_gate));
  lines.push(...autonomyPlan.renderAutonomyPlanMarkdown(rollup.autonomy_plan));
  lines.push(...autonomyApprovalReceiptValidation.renderAutonomyApprovalReceiptValidationMarkdown(rollup.autonomy_approval_receipt_validation));
  lines.push(...manualWorkPacket.renderManualWorkPacketMarkdown(rollup.manual_work_packet));
  return `${lines.join("\n")}\n`;
}
