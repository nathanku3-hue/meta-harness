...
function buildRepoRollup(root, options = {}) {
  ...
  const reviewPacket = proposalReviewPacket.buildProposalReviewPacket({
    proposalDraft,
    proposalValidation: validation,
    proposalReviewGate: reviewGate,
  });
  return {
    ...
    proposal_review_options: proposalReviewOptions.buildProposalReviewOptions({ proposalReviewPacket: reviewPacket }),
    repos,
