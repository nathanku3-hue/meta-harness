...
const proposalReviewReceiptTemplate = require("./repo-rollup-proposal-review-receipt-template"), proposalReviewReceiptValidation = require("./repo-rollup-proposal-review-" + "receipt-validation");
...
function buildRepoRollup(root, options = {}) {
  ...
  return {
    ...
    proposal_review_receipt_template: receiptTemplate, ["proposal_review_" + "receipt_validation"]: receiptValidation,
    repos,
...
function renderRepoRollupMarkdown(rollup) {
  ...
  lines.push(...proposalReviewReceiptTemplate.renderProposalReviewReceiptTemplateMarkdown(rollup.proposal_review_receipt_template)); lines.push(...proposalReviewReceiptValidation.renderProposalReviewReceiptValidationMarkdown(rollup["proposal_review_" + "receipt_validation"]));
  return `${lines.join("\n")}\n`;
}
