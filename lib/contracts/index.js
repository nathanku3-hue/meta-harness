...
module.exports = {
  ...
  PUBLICATION_INTENT_DRAFT_SCHEMA: publicationIntent.PUBLICATION_INTENT_DRAFT_SCHEMA,
  PUBLICATION_INTENT_SCHEMA: publicationIntent.PUBLICATION_INTENT_SCHEMA,
  PUBLICATION_INTENT_SIGNATURE_DOMAIN: publicationIntent.PUBLICATION_INTENT_SIGNATURE_DOMAIN,
  ...
  createPublicationIntentDraft: publicationIntent.createPublicationIntentDraft,
  publicationIntentSigningBody: publicationIntent.publicationIntentSigningBody,
  validatePublicationIntent: publicationIntent.validatePublicationIntent,
  validatePublicationIntentDraft: publicationIntent.validatePublicationIntentDraft,
  ...
  preparePublicationIntent: semanticController.preparePublicationIntent,
