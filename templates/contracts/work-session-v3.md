...
**Retired.** Active coding sessions use `work-session/v4`; see `templates/contracts/work-session-v4.md`. The v3 material below is retained for archive readability only.
