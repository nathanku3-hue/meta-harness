...
**Retired.** Active coding sessions use `work-session/v5`; see `templates/contracts/work-session-v5.md`. The v3 material below is retained for archive readability only and has no supported compatibility parser.
