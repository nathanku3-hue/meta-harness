...
**Retired.** Active coding sessions use `work-session/v7`. See `templates/contracts/work-session-v7.md`. The v2 material below is retained only for archive readability and has no supported compatibility parser.
