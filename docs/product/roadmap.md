...
| 20G | Explicit Copy/Export Rendering | prototype | Future only if needed after receipt-template safety is settled; no export or copy rendering is shipped in Phase 20F. |
