...
| 20B | Proposal Draft Validation | prototype | Deferred/future: draft validation may be considered later. Export/write/apply behavior, proposal files, queues, autonomy, dashboards, daemons, provider/network integration, and child command execution remain non-goals. |
